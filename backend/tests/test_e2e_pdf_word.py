...
async def test_conversion_flow():
    ...
    try:
        from app.utils.converter import run_python_conversion
        ...
        # 检查转换策略
        print("🎯 转换策略:")
        print(f"  • 小文件 (<20MB): pdfminer → PyMuPDF → pdfplumber")
        print(f"  • 大文件 (≥20MB): PyMuPDF → pdfminer → pdfplumber")
        print(f"  • PPT检测: 宽高比 1.7-1.8 (16:9) 或 1.3-1.4 (4:3)")
